    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
      ...
      <div class="col-span-1 text-whiteblue m-3 xl:m-5">
        ...
        <div class="bg-turquoise rounded-3xl p-5 space-y-5">
          ...
          <div class="col-span-12 md:col-span-5 flex">
            <div class="flex my-3 md:my-0 md:mt-auto space-x-2 cursor-pointer md:mx-auto md:w-full">
              <p class="py-3 text-center w-full border-2 rounded-full" @click="logout">Вийти</p>
            </div>
          </div>
        </div>
      </div>
