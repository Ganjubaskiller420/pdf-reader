<template>
  <h1 class="text-3xl text-gray-700 text-center font-sans leading-tight tracking-tight md:text-2xl">
    Вхід до акаунту
  </h1>
  <VeeForm
    v-slot="{ handleSubmit }"
...
export default {
  ...
  methods: {
    ...
    ...mapActions(useAuthStore, { loginSubmit: 'login' }),
    ...mapActions(useAlertStore, ['showAlert']),
    inputStyle(meta) {
      return (
        'border mt-4 sm:text-lg rounded-2xl block w-full p-3 bg-opacity-30 ' +
