  ...
  <div :id="`search-block-${name}`" class="flex-1 flex-col px-6 items-center z-50">
    <div class="flex flex-1 mt-3">
      <input
        ...
        type="search"
        class="relative block w-max min-w-0 flex-auto rounded-2xl border border-solid bg-transparent bg-clip-padding px-3 py-[0.25rem] text-sm font-normal leading-[1.8] outline-none transition duration-200 ease-in-out focus:z-[3] focus:outline-none"
        placeholder="Пошук"
        aria-label="Пошук"
